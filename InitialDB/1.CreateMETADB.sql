...
--Xóa dữ liệu trong dataflow
DELETE from DATA_FLOW_NDS

--Thêm giá trị của bảng stage vào dataflow để quản lý
INSERT INTO DATA_FLOW_NDS (NAME, STATUS, LSET, CET)
VALUES ('supermarket_sales_NDS', 1, '2006-01-01 00:00:00', '2007-01-01 00:00:00'),
...
--Cập nhật lại CET và LSET để nạp vào DDS
--NDS
update DATA_FLOW_NDS SET LSET = '2006-01-01 00:00:00' WHERE NAME = 'supermarket_sales_NDS'
update DATA_FLOW_NDS SET CET = '2006-01-01 00:00:00' WHERE NAME = 'supermarket_sales_NDS'

update DATA_FLOW_NDS SET LSET = '2006-01-01 00:00:00' WHERE NAME = 'product_NDS'
update DATA_FLOW_NDS SET CET = '2006-01-01 00:00:00' WHERE NAME = 'product_NDS'

update DATA_FLOW_NDS SET LSET = '2006-01-01 00:00:00' WHERE NAME = 'product_line_NDS'
update DATA_FLOW_NDS SET CET = '2006-01-01 00:00:00' WHERE NAME = 'product_line_NDS'

update DATA_FLOW_NDS SET LSET = '2006-01-01 00:00:00' WHERE NAME = 'city_NDS'
update DATA_FLOW_NDS SET CET = '2006-01-01 00:00:00' WHERE NAME = 'city_NDS'
